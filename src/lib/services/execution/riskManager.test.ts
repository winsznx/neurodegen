...
describe('classifyDrawdownTier', () => {
  it('returns each tier at its boundary', () => {
    // #given values straddling each ladder threshold
...
describe('RiskManager.canAct', () => {
  ...
  it('blocks opens but allows closes in defensive band', () => {
    // #given a state in the 20-25% defensive band
  ...
  it('halves position size at the 15% alert tier', () => {
    // #given a state in the 15-20% alert band
